...
Exposes a small allowlist of tables in FINANCE + AGENT so the front-end can
...
# DEMO_USER resolves to "FINANCE" by default (the Meridian Bank schema);
...
def get_rows(schema: str, table: str):
    ...
    try:
        ...
        # "no columns visible — check grants" error users hit on FINANCE
