...
There is no sixth TODO for identity. The rule set is installed for you by `app/scripts/setup_deep_security.py`, and the reference notebook's **Part 8** walks through what it enforces — see [Part 8](part-8-deep-data-security.md).
