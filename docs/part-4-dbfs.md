...
> 🧭 **Advanced reference.** The DBFS scratchpad is not one of the five core TODOs in the 90-minute path. It is live in the running app (`scratch_write` / `scratch_read` / `scratch_append`) and in the reference notebooks. Read this when you want the deeper chapter.
